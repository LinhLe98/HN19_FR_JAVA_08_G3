...
public class AttendantStatus {
	...
	public AttendantStatus(String milestoneName, int absentTime, int lateOrEarlyLeave, int noPermissionsRate,
			Double disciplinaryPoint, Trainee trainee) {
		super();
	...
	public String toString() {
		return "AttendantStatus [id=" + id + ", milestoneName=" + milestoneName + ", absentTime=" + absentTime
				+ ", lateOrEarlyLeave=" + lateOrEarlyLeave + ", noPermissionsRate=" + noPermissionsRate
